...
@section('content')
    ...
    <div class="card card-style overflow-visible mt-5">
        ...
        <div class="content mt-0 mb-2">
            <a class="list-group list-custom list-group-flush list-group-m rounded-xs">
                ...
                <a href="#" class="list-group-item" data-bs-toggle="offcanvas" data-bs-target="#menu-information">
                    <div class="d-flex">
                        <div class="align-self-center me-auto">Address</div>
                        <div class="align-self-center ms-auto">{{ $client->address }}</div>
                    </div>
                </a>
            </a>
        </div>
            ...
            @foreach($client->sales as $sale)
                <a href="#" class="list-group-item" data-bs-toggle="offcanvas"
                   data-bs-target="#menu-information">
                    <div class="d-flex">
                        <div class="align-self-center me-auto">Sale Number</div>
                        <div class="align-self-center ms-auto">{{ $sale->id }}</div>
                    </div>
                </a>
            @endforeach
        </div>
