<!-- BEGIN: Modal Toggle -->
<a href="javascript:;" data-tw-toggle="modal" data-tw-target="#static-backdrop-modal-product-{{ $product->id }}"
...
<!-- BEGIN: Modal Content -->
<div id="static-backdrop-modal-product-{{ $product->id }}" class="modal" data-tw-backdrop="static" tabindex="-1"
     aria-hidden="true">
