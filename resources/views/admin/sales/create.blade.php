        ...
        <div class="p-5 grid grid-cols-12">
            <div class="col-span-2 sm:col-span-3 relative">
                <div class="relative w-full">
                    <input list="products" id="product_name" type="text" class="inputs form-control search__input" placeholder="Product Name" autocomplete="off" data-tooltip-target="tooltip-default">
            ...
            <div class="col-span-2 sm:col-span-3 relative">
                <input id="product_price" onkeyup="count()" type="number" class="disable-it form-control" placeholder="Price">
            </div>
            <div class="col-span-2 sm:col-span-3 relative">
                <input id="product_count" onkeyup="count()" type="number" class="disable-it form-control" placeholder="Count">
            </div>
            <div class="col-span-2 sm:col-span-3 relative">
                <input id="product_amount" type="number" class="form-control floating-label" placeholder="Amount" disabled>
            </div>
        </div>
