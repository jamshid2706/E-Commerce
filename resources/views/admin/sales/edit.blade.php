...
@section('content')
    <h2 class=" text-lg font-medium mt-10">Editting Sale {{ $sale->id }}</h2>
        ...
        <div class="px-5 sm:px-16 overflow-y-scroll scrollbar-hidden" style="height: 300px">
            <form class="mt-3" action="{{route('admin.sales.store')}}" method="post">
                ...
                <table class="table max-h-full">
                    ...
                    <tr>
                            <td class="border-b dark:border-darkmode-400">
                                <div class="font-medium whitespace-nowrap">{{ $prod->title }}</div>
                        <td class="text-right border-b dark:border-darkmode-400 w-32">{{ $product->count }}</td>
                        <td class="text-right border-b dark:border-darkmode-400 w-32">{{ $product->price }}</td>
                        <td class="text-right border-b dark:border-darkmode-400 w-32 font-medium">{{ $product->total }}</td>
                        <td class="text-right border-b dark:border-darkmode-400 w-32 font-medium">
                            <a class="btn btn-outline-danger flex items-center text-danger" href="javascript:;" data-tw-toggle="modal"
                               data-tw-target="#delete-confirmation-modal">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
