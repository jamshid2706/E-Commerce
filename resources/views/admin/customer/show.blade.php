...
@section('content')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">{{ $customer->name }}</h2>
    </div>
    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 pb-5 -mx-5">
            <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                ...
                <div class="ml-5">
                    <div
                        class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg">{{ $customer->name }}</div>
                </div>
            </div>
            <div
                class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r-0 border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                        ...
                        <div class="box p-5">
                            <div class="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     ...
                                     stroke-linejoin="round" icon-name="shopping-cart" data-lucide="shopping-cart"
            ...
            <div
                class="mt-6 lg:mt-0 flex-1 px-5 border-l-0 border-r-0 border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                <div class="col-span-12 sm:col-span-4 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            <div class="flex">
                                ...
                                <div class="ml-auto">
                                    <div class="report-box__indicator bg-success tooltip cursor-pointer">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             ...
                                             stroke-linecap="round" stroke-linejoin="round" icon-name="chevron-up"
                                             data-lucide="chevron-up" class="lucide lucide-chevron-up w-4 h-4 ml-0.5">
                ...
                <div id="faq-accordion-content-5" style="cursor: pointer;" title="Bosing malumotlarni ko`rasz!"
                    ...
                    <div class="rounded-md accordion-button dark:bg-darkmode-600 collapsed"
                        ...
                        <div class="grid-cols-10 grid">
                            ...
                            <div class="col-span-3 flex items-center"><i data-lucide="map-pin"
                                                                         class="px-1 h-full"></i>{{ $sale->client->address ?? '' }}
                            </div>
                            <div class="flex items-center"><i data-lucide="banknote"
                                                              class="px-1 h-full"></i>{{ $sale->amount ?? '' }}</div>
                            <div
                                class="flex items-center justify-end">{{ $sale->created_at->format('d-m-Y') ?? '' }}</div>
                                ...
                                <div class="flex justify-end items-center">
                                    ...
                                    <div class="flex mt-4 lg:mt-0">
                                        <a href="javascript:;" data-tw-toggle="modal"
                                           ...
                                           class="btn btn-outline-danger mr-3"><i data-lucide="trash-2"
                                                                                  class="px-1 h-full"></i>Delete</a>
                                    </div>
                                    <!-- END: Modal Toggle -->
                                    <!-- BEGIN: Modal Content -->
