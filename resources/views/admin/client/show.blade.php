    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
            ...
            <div class="mt-6 lg:mt-0 flex-1 px-5 border-t lg:border-0 border-slate-200/60 dark:border-darkmode-400 pt-5 lg:pt-0">
                ...
                <div class="flex items-center justify-center lg:justify-start mt-2">
                    ...
                    <div class="w-3/4">
                        <div class="h-[55px]">
                            <canvas class="simple-line-chart-1 -mr-5" style="display: block; box-sizing: border-box; height: 55px; width: 389px;" width="389" height="55"></canvas>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-center lg:justify-start">
                    ...
                    <div class="w-3/4">
                        <div class="h-[55px]">
                            <canvas class="simple-line-chart-2 -mr-5" style="display: block; box-sizing: border-box; height: 55px; width: 389px;" width="389" height="55"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center" role="tablist">
            ...
            <li id="tasks-tab" class="nav-item" role="presentation">
                <a href="javascript:;" class="nav-link py-4" data-tw-target="#tasks" aria-selected="false" role="tab">
                    Tasks
                </a>
            </li>
        </ul>
